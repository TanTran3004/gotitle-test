...
const ListUser = React.lazy(() =>
    import ("./views/listUser/ListUser.jsx"));
const ListTitle = React.lazy(() =>
    import ("./views/listTitle/ListTitle"));
const ShowErr = React.lazy(() =>
    import ("./views/showErrors/ShowErr"));
const routes = [
    ...
    { path: "/list-users", name: "List Users", component: ListUser },
    { path: "/list-title", name: "List Title", component: ListTitle },
    { path: "/show-errs", name: "Show Errors", component: ShowErr },
];
